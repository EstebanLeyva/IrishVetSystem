...
<body  topmargin="" leftmargin="160">
	...
	<nav role="navigation"  id="colorNav">
		...
		$query="SELECT * FROM propietarios WHERE id_propietario='$id_propietario'";
		$resultado= $conexion->query($query);
		$row=$resultado->fetch_assoc();
		?>

		<div align="center">
			<form action="nuevoPaciente.php" method="POST" method="POST"></br></br>
				<div class="form-group">
					<H1 class="form-group" id="text_form">Registro Nuevo Paciente</H1><br>
					<label>ID PROPIETARIO</label>
					<input id="input" required name="id_p" value="<?php echo $row['id_propietario']; ?>" type="text"  class="form-control input-lg text-center" placeholder="ID PROPIETARIO" readonly>
					<br>
